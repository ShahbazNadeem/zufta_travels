                    ...
                    <div className="container">
                        <div className="flex flex-col md:flex-row gap-8 md:gap-18 lg:gap-36">
                            <div className="basis-1/2">
                                <h2 className='text-center md:text-left'>If we can find the right way to teach people about wildlife, they will be touched.</h2>
                            </div>
                            <div className="basis-1/2">
                    ...
                    <div className="container">
                        <div className="flex flex-col md:flex-row gap-8">
                            ...
                            <div className="md:basis-1/2 flex flex-col gap-8">
                                <h2 className='text-center md:text-left'>A comprehensive suite of payment products fully integrated.</h2>
                    ...
                    <div className="container">
                        <div className="flex flex-col gap-8 md:gap-12">
                            <div className="flex flex-col gap-8">
                                <h2 className='text-center'>Transforming Dreams into Reality</h2>
