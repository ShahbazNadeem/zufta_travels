          ...
          <div className="container">
            <div className="">
              <ul className=" flex items-center gap-5">
                <li className="text-black p-5">Overview</li>
                <li className="text-black p-5">Tour Plan</li>
                <li className="text-black p-5">Pricing</li>
                <li className="text-black p-5">FAQs</li>
              </ul>
            </div>
